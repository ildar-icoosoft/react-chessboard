...
<p align="center">
    ...
    <a href="https://www.npmjs.com/package/ii-react-chessboard">
        <img alt="npm" src="https://img.shields.io/npm/v/ii-react-chessboard">
    </a>
</p>
...
| onSetPremove | (move: [Move](#move), playPremove: () => void, cancelPremove: () => void): void | | called after the premove has been set |
